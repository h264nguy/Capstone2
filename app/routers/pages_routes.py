...
<body><div class='page'>
  <h1>Tipsy</h1>
  <div class='pill' style='display:inline-block; margin:0 0 14px 0; background:rgba(80,160,255,.14); border:1px solid rgba(80,160,255,.42); color:#f5e6d3'>VOICE BUILD: 2026-03-29 DEBUG A</div>
...
<div id='menu' class='grid cards' style='margin-top:14px'></div>
    ...
    <div class='small' style='margin-top:8px;opacity:.9'>Voice test: say <strong>Voltage Fizz</strong>, <strong>checkout</strong>, or <strong>clear cart</strong>. If the page updates, the new build is live.</div>
